    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          ...
          {username && (
            <p className='absolute right-[-8px] bottom-[-7px] w-5 h-3.5 text-center leading-4 bg-black text-white aspect-square text-[9px] pr-0.5 pl-0.5'>{username.split(' ')[0]}</p>//</span>
          )}
